...
#define ORIGINAL_FILE_NAME "UE4Editor-Studio2Project.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Studio2Project
#define DEPRECATED_FORGAME DEPRECATED
#define STUDIO2PROJECT_API DLLEXPORT
